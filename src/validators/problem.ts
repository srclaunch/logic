import { AuthenticationCondition, Condition } from '../conditions/index';

export interface ValidationProblemClass {
  condition?: Condition;
  message?: {
    short: string;
    long: string;
...
export class ValidationProblem implements ValidationProblemClass {
  ...
  constructor(
    ...
    this.message = this.getValidationProblemLabel(condition, context);
  }
